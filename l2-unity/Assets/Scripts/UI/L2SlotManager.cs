...
public class L2SlotManager : L2PopupWindow
{
    ...
    private void DestroyRecipe()
    {
        ...
        SystemMessageWindow.Instance.OnButtonClosed += OnÑancelRecipe;
    ...
    {
        SystemMessageUtils.CancelEvent(SystemMessageWindow.Instance, OkDestroyRecipe, OnÑancelRecipe);
    }
