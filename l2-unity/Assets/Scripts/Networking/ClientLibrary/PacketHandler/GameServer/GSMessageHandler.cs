...
public class GSMessageHandler : ServerPacketHandler
{
    ...
    public override void HandlePacket(IData itemQueue)
    {
        ...
        GSMessagePacketType type = (GSMessagePacketType)item.ByteType();

        switch (type)
        {
            case GSMessagePacketType.SystemMessage:
                OnMessage(itemQueue.DecodeData());
                break;
            case GSMessagePacketType.CreatureSay:
                OnCreatureSay(itemQueue.DecodeData());
                break;
            case GSMessagePacketType.NpcSay:
