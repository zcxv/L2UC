...
{
    private bool isKeyAuthCompleted = false;
    ...
    private void UsePacket(ItemServer item, IData itemQueue)
    {
        ...
        {
            case GameServerPacketType.VersionCheckPacket:
                OnVersionCheckReceive(itemQueue.DecodeData());
                break;
            case GameServerPacketType.CharSelectionInfo:

                OnCharSelectionInfo(itemQueue.DecodeData());
                break;
            case GameServerPacketType.CharTemplate:
            ...
            case GameServerPacketType.SkillCoolTime:
                ...
                break;
            case GameServerPacketType.MacroList:

                OnCharMacroList(itemQueue.DecodeData());
                break;
            case GameServerPacketType.NpcHtmlMessage:
            ...
            case GameServerPacketType.PackageToList:
                ...
                break;
            case GameServerPacketType.TutorialShowHtml:
            ...
            case GameServerPacketType.BuyList:
                ...
                break;
            case GameServerPacketType.ShopPreviewList:
                OnShopPreviewList(itemQueue.DecodeData());
                break;
            case GameServerPacketType.ShopPreviewInfo:
                OnShopPreviewInfo(itemQueue.DecodeData());
                break;
            case GameServerPacketType.MultiSellList:
            ...
            case GameServerPacketType.SellList:
                ...
                break;
            case GameServerPacketType.WhDepositList:
            ...
            case GameServerPacketType.PackageSendableList:
                ...
                break;
            case GameServerPacketType.WhWithdrawList:

                OnWhWithdrawList(itemQueue.DecodeData());
                break;
            case GameServerPacketType.BuyListSeed:
            ...
            case GameServerPacketType.ShortCutRegister:
                ...
                break;
            case GameServerPacketType.ShortCutDel:
            ...
            case GameServerPacketType.Revive:
                ...
                break;
            case GameServerPacketType.HennaInfo:

                OnCharHennaInfo(itemQueue.DecodeData());
                break;
            case GameServerPacketType.QuestList:
            ...
            case GameServerPacketType.NpcInfo:
                ...
                break;
            case GameServerPacketType.DeleteObject:

                OnDeleteObject(itemQueue.DecodeData());
                break;
            case GameServerPacketType.CharMoveToLocation:
            ...
            case GameServerPacketType.ValidateLocation:
                ...
                break;
            case GameServerPacketType.FriendList:
            ...
            case GameServerPacketType.AcquireSkillInfo:
                ...
                break;
            case GameServerPacketType.RecipeBookItemList:

                OnRecipeBookItemList(itemQueue.DecodeData());
                break;
            case GameServerPacketType.RecipeItemMakeInfo:
            ...
            case GameServerPacketType.TradeStart:
                ...
                break;
            case GameServerPacketType.TradeDone:
            ...
            case GameServerPacketType.DropItem:
                break;
            case GameServerPacketType.CharInfo:
                break;
    ...
    private void UseExPacket(int exPacket, IData itemQueue)
    {
        switch (exPacket)
        {
            case (int)GameExServerPacketType.ExShowQuestInfo:
                OnExShowQuestInfo(itemQueue.DecodeExData());
                break;
            case (int)GameExServerPacketType.ExShowSellCropList:
                OnExShowSellCropList(itemQueue.DecodeExData());
                break;
            case (int)GameExServerPacketType.ExShowSeedInfo:
                OnExShowSeedInfo(itemQueue.DecodeExData());
                break;
            case (int)GameExServerPacketType.ExShowCropInfo:
                OnExShowCropInfo(itemQueue.DecodeExData());
                break;
            case (int)GameExServerPacketType.ExShowManorDefaultInfo:
                OnExShowManorDefaultInfo(itemQueue.DecodeExData());
                break;
            case (int)GameExServerPacketType.ExPledgeReceiveMemberInfo:
                OnExPledgeReceiveMemberInfo(itemQueue.DecodeExData());
                break;
            case (int)GameExServerPacketType.ExOnExPledgePowerGradeList:
                OnExPledgePowerGradeList(itemQueue.DecodeExData());
                break;
            case (int)GameExServerPacketType.ExPledgeReceivePowerInfo:
    ...
    private void OnVersionCheckReceive(byte[] data)
    {
        VersionCheckPacket packet = new VersionCheckPacket(data);
        if (!isKeyAuthCompleted)
        {
            ...
            var sendPaket = GameLobbyPacketFactory.CreateAuthLogin(LoginClient.Instance.Account, GameClient.Instance.PlayKey1, GameClient.Instance.PlayKey2,
    ...
    private void OnCharSelectionInfo(byte[] data)
    {
        ...
        EventProcessor.Instance.QueueEvent(() => {
            ...
            SelectorController.Instance.SetPackages(packet.Characters);
            SelectorController.Instance.Select(packet.SelectedSlotId);
    ...
    private void OnCharSkillList(byte[] data)
    {
        ...
        PlayerInfo info1 = GameClient.Instance.PlayerInfo;
    ...
    private void OnBuyList(byte[] data)
    {
        ...
        EventProcessor.Instance.QueueEvent(() => {
            ...
            DealerWindow.Instance.UpdateDataForm(buyList.CurrentMoney, info.PlayerInfo.Stats.WeightPercent(), info.PlayerInfo.Stats.CurrWeight, info.PlayerInfo.Stats.MaxWeight);
    ...
    public void OnShopPreviewList(byte[] data)
    {
        ...
        EventProcessor.Instance.QueueEvent(() => {
            ...
            DealerWindow.Instance.UpdateDataForm(shopPreviewList.CurrentMoney, info.PlayerInfo.Stats.WeightPercent(), info.PlayerInfo.Stats.CurrWeight, info.PlayerInfo.Stats.MaxWeight);
            DealerWindow.Instance.ShowWindowToCenter();
        });
    }
    ...
    private void OnSellList(byte[] data)
    {
        ...
        EventProcessor.Instance.QueueEvent(() => {
            ...
            DealerWindow.Instance.UpdateDataForm(sellList.CurrentMoney, info.PlayerInfo.Stats.WeightPercent(), info.PlayerInfo.Stats.CurrWeight, info.PlayerInfo.Stats.MaxWeight);
    ...
    private void OnWhDepositList(byte[] data)
    {
        ...
        EventProcessor.Instance.QueueEvent(() => {
            ...
            DealerWindow.Instance.UpdateDataForm(whList.CurrentMoney, info.PlayerInfo.Stats.WeightPercent(), info.PlayerInfo.Stats.CurrWeight, info.PlayerInfo.Stats.MaxWeight);
            DealerWindow.Instance.ShowWindow();
        });
    }
    ...
    public void OnPackageSendableList(byte[] data)
    {
        ...
        EventProcessor.Instance.QueueEvent(() => {
            ...
            DealerWindow.Instance.UpdateDataForm(list.CurrentMoney, info.PlayerInfo.Stats.WeightPercent(), info.PlayerInfo.Stats.CurrWeight, info.PlayerInfo.Stats.MaxWeight);
            DealerWindow.Instance.ShowWindow();
        });
    ...
    public void OnBuyListSeed(byte[] data)
    {
        ...
        EventProcessor.Instance.QueueEvent(() => {
            ...
            DealerWindow.Instance.UpdateDataForm(listSeed.CurrentMoney, info.PlayerInfo.Stats.WeightPercent(), info.PlayerInfo.Stats.CurrWeight, info.PlayerInfo.Stats.MaxWeight);
            DealerWindow.Instance.ShowWindow();
        });
    }
