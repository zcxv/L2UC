...
namespace AlefCrypto
{
    ...
    public class BlowfishContext
    {
        ...
        {
            _p = BlowfishTable.P.Clone() as uint[];
            _s = BlowfishTable.S.Clone() as uint[,];
        ...
        /// <param name="length">The length of data to encrypt.</param>
        ...
        /// <param name="length">The length of data to decrypt.</param>
        ...
        {
            var d = (ushort)(number & 0x00FF);
            number >>= 8;
            var c = (ushort)(number & 0x00FF);
            number >>= 8;
            var b = (ushort)(number & 0x00FF);
            number >>= 8;
            var a = (ushort)(number & 0x00FF);
