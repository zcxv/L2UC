...
public class CharacterDefaultEquipment {
    ...
    public static int[] GetDefaultItemsByItemSlot(ItemSlot slot) {
        return slot switch {
            ItemSlot.chest => new[] { ItemTable.NAKED_CHEST },
            ItemSlot.legs => new[] { ItemTable.NAKED_LEGS },
            ItemSlot.gloves => new[] { ItemTable.NAKED_GLOVES },
            ItemSlot.feet => new[] { ItemTable.NAKED_BOOTS },
            ItemSlot.fullarmor => new[] { ItemTable.NAKED_CHEST, ItemTable.NAKED_LEGS },
